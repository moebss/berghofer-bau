  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-orange-600 selection:text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-extrabold text-lg sm:text-xl text-slate-950 tracking-tight block">
                Berghofer Wolfgang Bauunternehmen
              </span>
              <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider block">
                Meisterbetrieb • Bauunternehmen & Hochbau
              </span>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <a href="tel:02261920487" className="hidden sm:flex items-center gap-2 text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 px-3.5 py-2 rounded-xl border border-slate-200 transition-all"><Phone className="w-3.5 h-3.5 text-slate-900" /><span>02261920487</span></a>
            <button
      ...
      <section className="relative min-h-[80vh] flex flex-col lg:flex-row bg-slate-50 border-b border-slate-200 overflow-hidden">
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-16 lg:py-24 space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-950 leading-[1.1] text-balance">
            Meistergeführter Hochbau, Rohbau & Fundamentarbeiten im Oberbergischen Kreis
          </h1>

          <p className="text-base sm:text-lg text-slate-700 leading-relaxed text-pretty">
            Ihr verlässlicher Partner für Bauunternehmen & Hochbau. Wir garantieren höchste Ausführungsqualität, meisterhafte Handwerkskunst und feste Terminabsprachen.
          </p>
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-4">
            ...
            <a href="tel:02261920487" className="inline-flex items-center justify-center gap-3 bg-slate-950 hover:bg-slate-800 text-white font-bold text-sm px-6 py-4 rounded-xl shadow-sm transition-all"><Phone className="w-4 h-4 text-slate-300" /><span>Direkt anrufen: 02261920487</span></a>
          </div>
        ...
        <div className="w-full lg:w-1/2 relative min-h-[380px] lg:min-h-full bg-slate-900 flex items-center justify-center p-8">
          ...
          <div className="relative z-10 text-center space-y-4 max-w-md p-8 border border-slate-800 rounded-3xl bg-slate-900/80 backdrop-blur-md shadow-2xl">
            ...
            <h3 className="text-2xl font-extrabold text-white">Berghofer Wolfgang Bauunternehmen</h3>
            ...
            <div className="pt-2 flex items-center justify-center gap-2 text-xs font-bold text-slate-400">
              <span>Ansprechpartner: Wolfgang Berghofer</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-8 bg-slate-950 text-slate-400 text-xs border-t border-slate-900 text-center">
        <p>© {new Date().getFullYear()} Berghofer Wolfgang Bauunternehmen. Alle Rechte vorbehalten. Meisterbetrieb.</p>
      </footer>
